...
\input{src/cmds/csp-commands.tex}
...
\input{src/texs/10-csp-background.tex}
\input{src/texs/11-csp-proposed-technique.tex}
\input{src/texs/20-pathfinding-background.tex}
\input{src/texs/21-pathfinding-proposed-technique.tex}
